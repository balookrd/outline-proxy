...
Дашборды **всё ещё есть внутри `outline-ws-rust` и `outline-ss-rust`**. Их
удаление осознанно отложено до тех пор, пока этот сервис не будет обкатан на
практике; до тех пор один и тот же UI доступен и на узле, и в кластере.

Дизайн и план:
[спека](../../docs/superpowers/specs/2026-08-12-outline-ui-dashboard-extraction-design.md),
[план](../../docs/superpowers/plans/2026-08-12-outline-ui.md) (задачи 9-10 ждут).
