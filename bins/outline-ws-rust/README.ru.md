...
- Наблюдается на `outline_ws_tun_tcp_events_total{event=…}`: `soft_switch_migrated` и `soft_switch_migration_failed` (за вторым следует обычный `global_switch`-teardown).
