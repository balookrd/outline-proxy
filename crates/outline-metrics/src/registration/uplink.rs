...
pub(super) fn build(registry: &Registry) -> UplinkFields {
    let uplink_selected_total = register_labeled!(
        registry,
        IntCounterVec,
        "outline_ws_uplink_selected_total",
    ...
    let uplink_runtime_failures_total = register_labeled!(
        registry,
        IntCounterVec,
        "outline_ws_uplink_runtime_failures_total",
    ...
    let uplink_runtime_failures_suppressed_total = register_labeled!(
        registry,
        IntCounterVec,
        "outline_ws_uplink_runtime_failures_suppressed_total",
    ...
    let uplink_runtime_failure_causes_total = register_labeled!(
        registry,
        IntCounterVec,
        "outline_ws_uplink_runtime_failure_causes_total",
    ...
    let uplink_runtime_failure_signatures_total = register_labeled!(
        registry,
        IntCounterVec,
        "outline_ws_uplink_runtime_failure_signatures_total",
    ...
    let uplink_failovers_total = register_labeled!(
        registry,
        IntCounterVec,
        "outline_ws_uplink_failovers_total",
    ...
    let uplink_mid_session_retries_total = register_labeled!(
        registry,
        IntCounterVec,
        "outline_ws_uplink_mid_session_retries_total",
    ...
    let uplink_health_effective = register_labeled!(
        registry,
        GaugeVec,
        "outline_ws_uplink_health_effective",
        "Effective uplink health by transport: 1 when probe-confirmed OR (for uplinks with at least one fallback) when any wire has dialed successfully within the runtime-failure window. The 'is this uplink delivering traffic?' signal that dashboards should prefer; equals `outline_ws_uplink_health` for single-wire uplinks.",
        ["group", "transport", "uplink"]
    );
    let uplink_latency_seconds = register_labeled!(
        registry,
        GaugeVec,
        "outline_ws_uplink_latency_seconds",
    ...
    let uplink_rtt_ewma_seconds = register_labeled!(
        registry,
        GaugeVec,
        "outline_ws_uplink_rtt_ewma_seconds",
    ...
    let uplink_penalty_seconds = register_labeled!(
        registry,
        GaugeVec,
        "outline_ws_uplink_penalty_seconds",
    ...
    let uplink_effective_latency_seconds = register_labeled!(
        registry,
        GaugeVec,
        "outline_ws_uplink_effective_latency_seconds",
    ...
    let uplink_score_seconds = register_labeled!(
        registry,
        GaugeVec,
        "outline_ws_uplink_score_seconds",
    ...
    let uplink_cert_expiry_timestamp_seconds = register_labeled!(
        registry,
        GaugeVec,
        "outline_ws_uplink_cert_expiry_timestamp_seconds",
    ...
    let uplink_cooldown_seconds = register_labeled!(
        registry,
        GaugeVec,
        "outline_ws_uplink_cooldown_seconds",
    ...
    let uplink_standby_ready = register_labeled!(
        registry,
        IntGaugeVec,
        "outline_ws_uplink_standby_ready",
    ...
    let uplink_active_wire_pin_remaining_seconds = register_labeled!(
        registry,
        GaugeVec,
        "outline_ws_uplink_active_wire_pin_remaining_seconds",
    ...
    let uplink_configured_fallbacks_count = register_labeled!(
        registry,
        IntGaugeVec,
        "outline_ws_uplink_configured_fallbacks",
    ...
    let uplink_mode_downgrade_remaining_seconds = register_labeled!(
        registry,
        GaugeVec,
        "outline_ws_uplink_mode_downgrade_remaining_seconds",
    ...
    let uplink_mode_downgrade_capped_to_info = register_labeled!(
        registry,
        IntGaugeVec,
        "outline_ws_uplink_mode_downgrade_capped_to_info",
    ...
    let selection_mode_info = register_labeled!(
        registry,
        IntGaugeVec,
        "outline_ws_selection_mode_info",
    ...
    let global_active_uplink_info = register_labeled!(
        registry,
        IntGaugeVec,
        "outline_ws_global_active_uplink_info",
    ...
    let per_uplink_active_uplink_info = register_labeled!(
        registry,
        IntGaugeVec,
        "outline_ws_per_uplink_active_uplink_info",
    ...
    let sticky_routes_by_uplink = register_labeled!(
        registry,
        IntGaugeVec,
        "outline_ws_sticky_routes_by_uplink",
    ...
    let uplink_fingerprint_profile_strategy_info = register_labeled!(
        registry,
        IntGaugeVec,
        "outline_ws_uplink_fingerprint_profile_strategy_info",
    ...
    let uplink_open_connections = register_labeled!(
        registry,
        IntGaugeVec,
        "outline_ws_uplink_open_connections",
        "Currently open upstream transports attributed to this uplink, by transport \
         ...
         `outline_ws_global_active_uplink_info` / \
         `outline_ws_per_uplink_active_uplink_info` and \
         `outline_ws_socks_tcp_strict_aborts_total` — see the dashboard panel \
    ...
    let uplink_connection_close_total = register_labeled!(
        registry,
        IntCounterVec,
        "outline_ws_uplink_connection_close_total",
    ...
    let resume_lookup_total = register_labeled!(
        registry,
        IntCounterVec,
        "outline_ws_resume_lookup_total",
