...
impl Metrics {
    pub(super) fn new() -> Self {
        ...
        Self {
            ...
            uplink_payload_integrity_errors_total: u.uplink_payload_integrity_errors_total,
            uplink_failovers_total: u.uplink_failovers_total,
            uplink_loss_failovers_total: u.uplink_loss_failovers_total,
            uplink_mid_session_retries_total: u.uplink_mid_session_retries_total,
            ...
            uplink_latency_inflated_seconds: u.uplink_latency_inflated_seconds,
            ...
            uplink_enabled: u.uplink_enabled,
