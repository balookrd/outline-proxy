...
#[cfg(test)]
pub(in crate::tcp) fn normalize_client_segment(
    packet: &ParsedTcpPacket,
    expected_seq: u32,
) -> ClientSegmentView {
...
pub(in crate::tcp) fn queue_future_segment(
    pending_segments: &mut VecDeque<BufferedClientSegment>,
    packet: &TrimmedSegment,
    expected_seq: u32,
) {
...
pub(in crate::tcp) enum QueueFutureSegmentOutcome {
...
pub(in crate::tcp) fn queue_future_segment_with_recv_window(
...
pub(in crate::tcp) fn exceeds_client_reassembly_limits(
    state: &TcpFlowState,
    config: &TunTcpConfig,
) -> bool {
...
pub(in crate::tcp) fn is_duplicate_syn(packet: &ParsedTcpPacket, expected_seq: u32) -> bool {
