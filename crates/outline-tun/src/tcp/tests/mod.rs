...
pub(super) fn test_tun_tcp_config() -> TunTcpConfig {
    TunTcpConfig {
        ...
        sniff_override_include: std::sync::Arc::new(arc_swap::ArcSwap::from_pointee(Vec::new())),
        sniff_override_exclude: std::sync::Arc::new(arc_swap::ArcSwap::from_pointee(Vec::new())),
